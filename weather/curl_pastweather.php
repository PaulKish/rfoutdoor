...
$loc_array= Array("Nairobi","Kenya");		//data validated in foreach. 
...
$api_key="b4d43d00840e41a7a29175027160105";
$date="2016-05-01";					//validated as $date_safe
$enddate="2016-05-01";				//optional included in example, validated as $enddate_safe
